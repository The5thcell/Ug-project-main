...
contract Tracking {
    ...
    event ShipmentCreated(address indexed sender, address indexed reciever, 
    ...
    event ShipmentDelivered(address indexed sender, address indexed receiver, uint256 deliverTime);
    ...
    public {
        ...
        require(shipment.receiver == _reciever, "Invalid receiver.");
        require(shipment.status == ShipmentStatus.IN_TRANSIT, "Shipment not in transit");
        require(!shipment.isPaid, "Shipement already paid.");
